# Badges de Produto — Proposta Inicial

Este documento serve como lista preliminar de badges para o portfólio. É uma
base antes da validação com o cliente, para manter consistência visual e
semântica.
...
- `NR-9` — Avaliação e controle de riscos (GRO/PGR).
...
- `NR-6 / NR-15` — Equipamento com uso em ambiente insalubre.
